package com.tecocity.mylibrary.log;
...
public class LogHelper {
    ...
    public static String[] wrapperContent(String tagStr, Object... objects) {
        ...
        StackTraceElement targetElement = stackTrace[LogHelper.STACK_TRACE_INDEX];
        ...
        String msg = (objects == null) ? LogHelper.NULL_TIPS : LogHelper.getObjectsString(objects);
