...
/**
 * 功能: SharedPreferences封装类
 * 作者: ibore
 * 时间: 2016/6/21 11:08
 * 邮箱: bore521@live.com
 */
public class XSharePreferences {
    private static SharedPreferences sharedPreferences;
    private static XSharePreferences mInstance;
    ...
    private XSharePreferences(@NonNull Context context){
    ...
    /**
     * @param context
     * @return Returns a 'XSharePreferences' instance
     */
    public static XSharePreferences with(@NonNull Context context) {
        if (mInstance == null) {
            mInstance = new XSharePreferences(context);
        }
        return mInstance;
    }
