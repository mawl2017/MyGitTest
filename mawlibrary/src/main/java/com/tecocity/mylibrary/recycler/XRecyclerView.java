...
public class XRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            mClipToPadding = a.getBoolean(R.styleable.XRecyclerView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.XRecyclerView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.XRecyclerView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.XRecyclerView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.XRecyclerView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.XRecyclerView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.XRecyclerView_scrollbarStyle, -1);

            mEmptyId = a.getResourceId(R.styleable.XRecyclerView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.XRecyclerView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.XRecyclerView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    private static class EasyDataObserver extends AdapterDataObserver {
        ...
        public EasyDataObserver(XRecyclerView recyclerView, boolean hasProgress) {
